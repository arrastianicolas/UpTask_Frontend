    ...
    return (
      <>
        ...
        <p className="text-2xl font-light text-gray-500 mt-5">
          Maneja y adminisitra tus proyectos
        </p>
        <nav className="my-5">
          <Link
            to="/projects/create"
                    ...
                    >
                      <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                        <MenuItem>
                          <Link
                            to={`/projects/${project._id}`}
                            className="block px-3 py-1 text-sm leading-6 text-gray-900 hover:bg-gray-200"
                          >
                            Ver Proyecto
                          </Link>
                        </MenuItem>
                        {isManager(project.manager, user._id) && (
                          <>
                            ...
                            <MenuItem>
                              <button
                                type="button"
                                className="block px-3 py-1 text-sm leading-6 text-red-500 hover:text-red-600 cursor-pointer"
                                onClick={() =>
                                  navigate(
                                    location.pathname +
